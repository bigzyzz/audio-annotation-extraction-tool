...
- [ ] 6. Update PROGRESS.md: move item from "Up Next" to "Done", note any decisions made. If a risk was created, changed, or closed, update RISK_REGISTER.md in the same PR. Confirm the matching Done-when checks in USER_STORIES.md.
```
